...
class TelnetClient:
    ...
    def dba_config_sfu(self):
        ...
        cn=sys._getframe().f_code.co_name
        cmds=['conf t',
              'create dba-profile 117 name chenjingv117 type4 max 1024000',
              'end',
    ...
    def dba_config_hgu(self):
        ...
        cn=sys._getframe().f_code.co_name
        cmds=['conf t',
              'create dba-profile 118 name chenjingv118 type4 max 1024000',
              'end',
    ...
    def line_config_sfu(self):
        ...
        check_words=['Line Profile Name: profile-117']
        output_lst=[]
    ...
    def line_config_hgu(self):
        ...
        check_words=['Line Profile Name: profile-118']
        output_lst=[]
    ...
    def service_config_sfu(self):
        ...
        cmds=['conf t',
              ...
              'exit',
              'end',
              'show gpon-onu-service-profile 117 | include file']
        # 配置service profile···
        check_name='tips:配置{}......'.format(self.service_type1)
        check_words=['Service Profile Name: profile-117']
        output_lst=[]
    ...
    def service_config_hgu(self):
        ...
        cn=sys._getframe().f_code.co_name
        cmds=['conf t',
              'gpon-onu-service-profile 118',
              'port-num veip 1',
              'commit',
              'exit',
              'end',
              'show gpon-onu-service-profile 118 | include file']
        # 配置service profile···
        check_name='tips:配置{}......'.format(self.service_type2)
        check_words=['Service Profile Name: profile-118']
        output_lst=[]
    ...
    def clear_config(self):
        ...
        cmds=['show interface gpon-onu creation-information | in {}'.format(self.pon_id),
              ...
              'end',
              'show gpon-onu-service-profile 117',
              'conf t',
              'no gpon-onu-service-profile 118',
              'end',
              'show gpon-onu-service-profile 118',
              'conf t',
...
if __name__ == '__main__':
    ...
    # 创建log文件
    output = open(os.path.join(os.getcwd(),'run_demo_x2_mult_vlan.log'),'w',encoding = 'utf-8')
    # 打印log开始时间
