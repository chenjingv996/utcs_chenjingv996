...
class TelnetClient:
    ...
    def dba_config(self):
        ...
        cmds=['no gpon-onu-line-profile 121-125',
              ...
              'show dba-profile 124',
              'create dba-profile 124 name chenjingv124 type4 max 1024000',
              'show dba-profile 124']
        #配置dba profile···
        check_name='配置dba profile......'
        check_words=['124         chenjingv124      type4']
        output_lst=[]
    ...
    def line_config(self):
        ...
        cn=sys._getframe().f_code.co_name
        cmds=['no gpon-onu-line-profile 121-125',
              'show gpon-onu-line-profile 124',
              'gpon-onu-line-profile 124',
            #   'mapping-mode port',
              'create tcont 1 dba-profile 124',
        ...
        check_words=['DBA Profile Name: chenjingv124']
        output_lst=[]
        self.check_res1(cn,cmds,check_name,check_words,output_lst)
    ...
    def service_config(self):
        ...
        cmds=['no gpon-onu-service-profile 121-125',
              'show gpon-onu-service-profile 124',
              'gpon-onu-service-profile 124',
              'port-num ethernet 4',
              #'uni ethernet 1-4 vlan trunk allowed 4000',
              'uni ethernet 1-4 vlan mode tagged',
              'uni ethernet 1-4 native vlan 4000',
              'commit',
              'exit',
              'show gpon-onu-service-profile 124 | section-end WLAN']
        #配置service profile···
    ...
    def clear_config(self):
        ...
        cmds=['int gpon-olt 3/3',
              'show interface gpon-onu creation-information | in 3/3',
              'show interface gpon-onu online-information | in 3/3',
              'no create gpon-onu 1-255',
              'exit',
              'no gpon-onu-line-profile 121-125',
              'show gpon-onu-line-profile 124',
              'no gpon-onu-service-profile 121-125',
              'show gpon-onu-service-profile 124',
              'no creat dba-profile 121-125',
              'show dba-profile 124',
              'show interface gpon-onu online-information | in 3/3',
              'show interface gpon-onu creation-information | in 3/3']
        #将ONU恢复缺省配置···
