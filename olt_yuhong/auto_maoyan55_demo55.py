...
username = 'admin'
pwd = 'admin123'
#cmd = 'pwd && arch && tail -3 /etc/passwd'
cmd_list = ['en','admin123','conf t','show onu state']

log_file=open(os.path.join(os.getcwd(),'output.log'),'w')
sys.stdout=log_file


def check_config(ipaddr, port, username, pwd, cmd_list):
    try:
        # 创建SSH对象
...
if __name__=="__main__":
    ...
    check_config(ipaddr,port,username,pwd,cmd_list)
