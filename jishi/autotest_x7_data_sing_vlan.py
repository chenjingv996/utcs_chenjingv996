...
class TelnetClient:
    ...
    def service_config_sfu(self):
        ...
        cmds=['gpon-onu-service-profile 115',
              ...
              'commit',
              'exit',
              'show gpon-onu-service-profile 115 | section-end WLAN']
        #配置service profile···
    ...
    def service_config_hgu(self):
        ...
        cmds=['gpon-onu-service-profile 116',
              ...
              'commit',
              'exit',
              'show gpon-onu-service-profile 116 | section-end WLAN']
        #配置service profile···
    ...
    def profile_bind(self):
        ...
        profile_type1='active   115  profile-115      115     profile-115'
        profile_type2='active   116  profile-116      116     profile-116'
